          ...
          <div style={styles.suggestedPrompts}>
            ...
            <div style={styles.promptButtons}>
              {[
                ...
                "Perform a Six Sigma and Lean analysis on this operational dataset. Calculate mean, standard deviation, UCL and LCL for key process metrics. Generate control charts flagging points outside control limits as special cause variation. Run a Pareto analysis to identify which defect or issue categories account for 80% of the problem. Calculate DPMO and sigma level. Use SHAP to identify root causes of process variation. Produce a full DMAIC summary with baseline sigma level, top root causes, recommended improvements, projected sigma level after improvements, and financial impact of moving from current to target sigma level."
              ].map((prompt, i) => (
